...
export default function Usercard(props: { image:string, title:string, name:string, description:string, top:boolean, titleColor:string, bottom:boolean }) {
    return (
        <span suppressHydrationWarning={true}>
            <div suppressHydrationWarning={true} style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',paddingBottom:'10px',paddingTop:'10px'}} className='dontDisplayOnMobile'>
                <div style={{width:'17vw',height:'25vh',paddingBottom:'0px',marginBottom:'25px'}}>
                    <img src={props.image} style={{width:'100%'}}/>
                </div>
                <div style={{width:'70%',marginLeft:'40px',paddingTop:'50px',paddingBottom:'20px',borderTop:(props.top?'none':'1px solid white'),borderBottom:(props.bottom?'1px solid white':'none')}}>
            ...
            <div suppressHydrationWarning={true} style={{width:'100%',paddingTop:'35px',borderTop:(props.top?'none':'1px solid white'),position:'relative',borderBottom:(props.bottom?'1px solid white':'none')}} className='dontDisplayOnDesktop'>
