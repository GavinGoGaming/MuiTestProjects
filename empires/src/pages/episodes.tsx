...
const EpisodeComponent = ({ episodes }: Readonly<{episodes: {name: string, description: string, thumbnail: string}[]}>) => {
            ...
            <main style={{ height: '100vh' }}>
                ...
                <Sheet sx={{ marginTop: '10px', width: '100%', background: '#181824', display: 'flex', justifyContent: 'center', alignItems: 'center', height: 'fit-content', paddingBottom: '50px', color: 'black' }}>
                    <Typography sx={{
                        ...
                        <EpisodeComponent episodes={[
                            {name: "Episode 1", description: "This is a description for it.", thumbnail: "https://img.youtube.com/vi/lLQdJ59U53o/maxresdefault.jpg"},
                            {name: "Episode 2", description: "This is a description for it.", thumbnail: "https://img.youtube.com/vi/lLQdJ59U53o/maxresdefault.jpg"},
                            {name: "Episode 3", description: "This is a description for it.", thumbnail: "https://img.youtube.com/vi/lLQdJ59U53o/maxresdefault.jpg"},
                            {name: "Episode 4", description: "This is a description for it.", thumbnail: "https://img.youtube.com/vi/lLQdJ59U53o/maxresdefault.jpg"},
                            {name: "Episode 5", description: "This is a description for it.", thumbnail: "https://img.youtube.com/vi/lLQdJ59U53o/maxresdefault.jpg"},
                            {name: "Episode 6", description: "This is a description for it.", thumbnail: "https://img.youtube.com/vi/lLQdJ59U53o/maxresdefault.jpg"},
                        ]}/>
                    </Typography>
                </Sheet>
                <Footer />
