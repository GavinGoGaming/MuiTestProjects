...
import { ArrowDownloadFilled, HomeFilled, FilmstripFilled, GridFilled, XboxControllerFilled } from '@fluentui/react-icons';
import './store.css';
    ...
    <Window title="Microsoft Store" defaultPosition={{x: 0, y:0}} defaultSize={{width: width-20, height: height-70}} id="store" taskbarIconID="store" color={'gray'}>
      <div className="window-full">
        <div className="store-left">
          ...
          <div className={"store-nav-icon sni-movies " + (currentPanel==='movies'?'active':'')} onClick={enable('movies')}><FilmstripFilled fontSize={'22px'}/></div>
