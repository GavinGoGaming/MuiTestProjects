...
export default function Movies() {
    ...
    function formatIconFilename(icon: string) {
        var icons = icon.replace('icons/','').replace('_',' ').split(' ');
        var formatted = '';
        icons.forEach((word)=>{
    ...
    return (
        <>
            ...
            <div style={{marginTop:'10px',paddingTop:'10px',borderTop:'1px solid #cccccc50'}}>
                ...
                <Input style={{margin:'5px'}} placeholder="App URL" onChange={(ev: any, data: any)=>{setAppURL(data.value)}} /><br/>
                ...
                <Dropdown style={{margin:'5px'}} selectedOptions={["normal"]} placeholder="App Type" onOptionSelect={(ev: any, data: any)=>{setAppType(data.optionValue)}}>
